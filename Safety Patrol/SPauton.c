...
#pragma config(Sensor, in1,    gBase1,         sensorNone)
...
#pragma config(Sensor, in6,    peBattery,      sensorAnalog)
#pragma config(Sensor, in7,    gLiftTilt,      sensorGyro)
...
#pragma config(Motor,  port1,           mMobileRight,  tmotorVex393_HBridge, openLoop)
...
#pragma config(Motor,  port10,          mMobileLeft,   tmotorVex393_HBridge, openLoop, reversed)
